			...
			<section id="content">
				<article>
					...
					<div class="panel panel-default">
						...
						/******* Display a table with notes information ********/
							...
							// Only show information if the rating is above -10
							// This is to remove any content that has been flagged by users too many times
									if($currentRate!=-10){
